...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/rosegeomap-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12329&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/rosegeomap-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `rosegeomap` can be installed with:

```
conda install rosegeomap
```

It is possible to list all of the versions of `rosegeomap` available on your platform with:
